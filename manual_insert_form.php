...
<body class="dg-dark">
  ...
  <div class="container">
    <div class="card card-register mx-auto mt-5">
        <div class="card-header">เพิ่มคู่มือดูแลรถ</div>
        <div class="card-body">


  <form action="manual_insert.php" method="post"enctype="multipart/form-data" id="from">




          <label>ภาพประกอบ: </label>
          <input name="manual_img" type="file" id="manual_img" class="form-control"  require="require">
         

          <label>บรรยายใต้ภาพ: </label>
          <input type="text" name="manual_caption" id="manual_caption" class="form-control" require="require" placecholder="ชื่อ">
