    ...
    <thead>
      <tr>
        ...
        <tr>
          ...
          <td><?php echo $row['manual_caption'];?></td>
          <td><?php echo $row['manual_head']; ?></td>
         
          <td><a href="manual_update_form.php?manual_id=<?php echo $row['manual_id']; ?>">แก้ไข</a></td>
          <td><a href="manual_delete.php?manual_id=<?php echo $row['manual_id']; ?>"><i class="fas fa-fw fa-trash" style="color:red"></i></a></td>
        </tr>
